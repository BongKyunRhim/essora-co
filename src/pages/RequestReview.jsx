  ...
  return (
    <section className="request-review-page">
      ...
      <div className="request-review-layout">
        ...
        {/* Title — col 1 row 1, aligns with top of price card */}
        <h1 className="rrl-form-title">Submit Your Essay</h1>

        {/* Price summary sidebar — spans both rows */}
        <aside className="rrl-price-card" style={{ gridRow: "1 / 3" }}>
